...
<Aside type="tip">
  SharkTrack is free and it makes us super-happy when people use it! Please fill in this [**30 seconds form**](https://forms.gle/sUeTarNqcTgxdyjU8) to tell us you are using SharkTrack.
</Aside>

## Overview

This page guides you to download SharkTrack and run it on your videos. This completes **Step 1** of the BRUVS analysis process.

{/* TODO: Uncomment when you have the step 1 image */}
{/* ![Step 1 diagram](../../../assets/figure1.png) */}
...
Once you have the output, move to the [Annotation Pipeline](/sharktrack/annotation-pipeline/) to compute MaxN.
...
| `--peek` | Run in [Peek Mode](#sharktrack-peek-mode). | — |
| `--chapters` | Aggregate video chapters into one single video. | — |
| `--resume` | Skip videos already analysed in the output path. | — |
...
Use SharkTrack to extract interesting frames without full tracking. This "peek" version runs **5x faster**, taking ~15% of real video time.
